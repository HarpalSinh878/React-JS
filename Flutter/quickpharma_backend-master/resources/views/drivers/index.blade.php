...
@section('content')
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="table-responsive">
                            <table style="font-family: 'Lato', sans-serif;" class="table-light table-striped table-responsive" aria-describedby="mydesc"
                                data-url="{{ url('driverList') }}" class='table-striped' id="table_list" data-toggle="table"
    ...
    <!--START:: addDriverModel-->
    <div class="modal fade" tabindex="-1" id="addDriverModal">
        <div class="modal-dialog">
            <div class="modal-content shadow-none">
                ...
                <form id="addForm" action="{{ route('driver.store') }}" method="POST" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row mb-3">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label text-center">Full Name</label>
                                    <!--end::Label-->
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row mb-3">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label text-center required">Username</label>
                                    <!--end::Label-->
                                    <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-8" data-kt-password-meter="true">
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-lg form-control-solid" required
                                                ...
                                                id="conform_password" autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" />
                                            <!--begin::Visibility toggle-->
                                            <span
                                                class="btn btn-sm btn-icon position-absolute translate-middle top-50 end-0 me-n2"
                                                data-kt-password-meter-control="visibility">
    ...
    <!--START:: editDriverModal-->

    <div class="modal fade" tabindex="-1" id="editDriverModal">
        <div class="modal-dialog">
            <div class="modal-content shadow-none">
                <div class="modal-header">
                ...
                <form id="addForm" action="{{ route('update.drivers') }}" method="POST" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <!--end::Label-->
                                    <div class="col-lg-8">
                                        <textarea class="form-control" name="address" id="edit_address" rows="2" data-kt-autosize="false"
    ...
    <div class="modal fade" tabindex="-1" id="resetPasswordModel">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="ResetPasswordForm" action="{{ route('reset-driver-password') }}" method="POST"
                    autocomplete="off">
                    @csrf
                    <div class="modal-body">
...
@section('script')
    <script>
        ...
        $('#ResetPasswordForm').submit(function() {
            ...
            //just to make sure once again during submi
            t
            //if both are true then only allow submit
            if (pass == confpass) {
                allowsubmit = true;
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.error == false) {
                        toastr.success('Driver Deactive successfully');
                        getUserStatistics();
                    }
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result.error == false) {
                            ...
                            toastr.success('All Driver Un-Ban successfully');
                            getUserStatistics();
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (result.error == false) {
                            ...
                            toastr.success('All Driver Ban successfully');
                            getUserStatistics();
                            checkedRows.splice(0, checkedRows.length);
                            $("#set_ban").text(checkedRows.length);
                        }
